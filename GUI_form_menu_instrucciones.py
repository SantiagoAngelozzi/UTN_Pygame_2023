...
class FormMenuInstrucciones(Form):
    def __init__(self,name,master_surface,x,y,w,h,color_background,color_border,active):
        ...
        self.instrucciones_3 = Label(master=self,x=0,y=300,w=700,h=50,color_background=None,color_border=None,image_background=None,text="*Tienes un total de 5, si la barra de vida llega a 0 pierdes.",font='Arial',font_size=20,font_color=C_RED)
