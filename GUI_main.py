...
form_menu_A = FormMenuA(name="form_menu_A",master_surface = screen,x=700,y=200,w=500,h=400,color_background=(255,255,0),color_border=(255,0,255),active=True)
form_menu_lvl = FormLvlSelect(name="form_level_select",master_surface = screen,x=700,y=200,w=500,h=400,color_background=(0,255,255),color_border=(255,0,255),active=False)
form_menu_B = FormMenuB(name="form_menu_B",master_surface = screen,x=700,y=200,w=500,h=400,color_background=(0,255,255),color_border=(255,0,255),active=False)
form_menu_win = FormMenuWin(name="form_menu_win",master_surface = screen,x=700,y=200,w=500,h=400,color_background=(0,255,255),color_border=(255,0,255),active=False)
form_menu_die = FormMenuGameOver(name="form_menu_die",master_surface = screen,x=700,y=200,w=500,h=400,color_background=(0,255,255),color_border=(255,0,255),active=False)
