...
class FormGameLevel1(Form):
    def __init__(self,name,master_surface,x,y,w,h,color_background,color_border,active):
        ...
        # --- GAME ELEMNTS --- 
        self.static_background = Background(x=0,y=0,width=w,height=h,path="UTN_Pygame_2023\images\locations\PC Computer - Puyo Puyo Champions - Desert.png", path_music ="UTN_Pygame_2023\sonido\La canción de Yoshi bailando -TACA A XERECA PRA MIM  sub español.mp3")
    ...
    # Restablecer las variables y elementos del nivel a sus valores iniciales
        self.player_1 = Player(x=0,y=650,speed_walk=7,speed_run=29,gravity=10,jump_power=20,frame_rate_ms=20,move_rate_ms=10,jump_height=150)
