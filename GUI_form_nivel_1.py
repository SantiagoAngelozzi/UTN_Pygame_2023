...
class FormGameLevel1(Form):
    def __init__(self,name,master_surface,x,y,w,h,color_background,color_border,active,nivel_json):
        ...
        # --- GUI WIDGET --- 
        self.button_menu = Button(master=self,x=0,y=0,w=140,h=50,color_background=None,color_border=None,image_background="UTN_Pygame_2023\images\set_gui_01\Comic_Border\Buttons\Button_M_02.png",on_click=self.on_click_boton1,on_click_param="form_menu_A",text="PAUSA",font="Verdana",font_size=30,font_color=C_WHITE)
    ...
    def generate_botin(self):
        data_botin = self.levels[0]["botin"]
