...
class FormMenuWin(Form):
    def __init__(self,name,master_surface,x,y,w,h,color_background,color_border,active):
        ...
        self.text_win = Label(master=self,x=150,y=0,w=200,h=50,color_background=None,color_border=None,image_background=None,text='YOU WIN',font='Arial',font_size=30,font_color=C_RED)
